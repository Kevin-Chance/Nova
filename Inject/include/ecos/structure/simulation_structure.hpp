...
private:
    ...
    using unbound_vector_connection = unbound_connection_t<std::vector<double>>;

    using unbound_connection = std::variant<unbound_int_connection, unbound_real_connection, unbound_string_connection, unbound_bool_connection,unbound_vector_connection>;
