...
typedef fmi2Status (STDCALL* fmi2GetVector_t)(fmi2Component*, const fmi2ValueReference[], size_t, fmi2Vector[]);
...
typedef fmi2Status(STDCALL* fmi2SetVector_t)(fmi2Component*, const fmi2ValueReference[], size_t, const fmi2Vector[], const fmi2Integer[]);
...
typedef fmi2Status (STDCALL *fmi2GetVectorStatus_t)(fmi2Component*, const fmi2StatusKind, fmi2Vector*);
