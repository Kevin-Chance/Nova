...
typedef const fmi2Real* fmi2Vector;
...
typedef enum { fmi2DataTypeReal, fmi2DataTypeInteger, fmi2DataTypeBoolean, fmi2DataTypeString, fmi2DataTypeEnumeration, fmi2DataTypeVector} fmi2DataType;
