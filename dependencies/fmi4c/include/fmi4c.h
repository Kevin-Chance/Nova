...
FMI4C_DLLAPI fmi2Vector fmi2_getVariableStartVector(fmi2VariableHandle* var, fmi2Integer* length);
...
FMI4C_DLLAPI fmi2Status fmi2_getVector(fmi2InstanceHandle* instance, const fmi2ValueReference valueReferences[], size_t nValueReferences, fmi2Vector values[]);
...
FMI4C_DLLAPI fmi2Status fmi2_setVector(fmi2InstanceHandle* instance, const fmi2ValueReference valueReferences[], size_t nValueReferences, const fmi2Vector values[], const fmi2Integer length[]);
...
FMI4C_DLLAPI fmi2Status fmi2_getVectorStatus(fmi2InstanceHandle* instance, const fmi2StatusKind s, fmi2Vector* value);
