...
fmi2Status STDCALL placeholder_fmi2_getVector(fmi2Component* component,
    const fmi2ValueReference vr[],
    size_t nvr,
    fmi2Vector value[])
{
    ...
    UNUSED(nvr);
    UNUSED(value);
    NOT_IMPLEMENTED(fmi2_getVector);
    return fmi2Error;
}
...
fmi2Status STDCALL placeholder_fmi2_setVector(fmi2Component* component,
    const fmi2ValueReference vr[],
    size_t nvr,
    const fmi2Vector value[], const fmi2Integer indices[])
{
    UNUSED(component);
    UNUSED(vr);
    UNUSED(nvr);
    UNUSED(value);
    UNUSED(indices)
    NOT_IMPLEMENTED(fmi2_setVector);
    return fmi2Error;
}
...
fmi2Status STDCALL placeholder_fmi2_getVectorStatus(fmi2Component* component,
    const fmi2StatusKind s,
    fmi2Vector* value)
{
    UNUSED(component);
    UNUSED(s);
    UNUSED(value);
    NOT_IMPLEMENTED(fmi2_getVectorStatus);
    return fmi2Error;
}
