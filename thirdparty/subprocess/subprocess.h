...
inline int subprocess_error_from_windows_error(unsigned long error) {
  enum {
    errorFileNotFound = 2,
    errorPathNotFound = 3,
...
inline int subprocess_error_from_errno(int error) {
  switch (error) {
  case ENOENT:
  case ENOTDIR:
    return subprocess_error_not_found;
...
inline void subprocess_close_handle(void **handle) {
...
inline int subprocess_create_named_pipe_helper(void **rd, void **wr) {
