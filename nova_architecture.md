...
**文件路径**：`include/nova/structure/simulation_structure.hpp`
...
### 1.2 类：`simulation`
**文件路径**：`include/nova/simulation.hpp`
...
### 1.3 类：`properties`
**文件路径**：`include/nova/property.hpp`
*   **功能**：管理模型实例的变量映射。
*   **公开方法**：
...
**文件路径**：`include/nova/nova_fmu_locator.hpp`
*   **公开方法**：
...
**文件路径**：`include/nova/model_instance.hpp`
*   **公开方法**：
...
**文件路径**：`include/nova/listeners/csv_writer.hpp`
*   **`csv_config` 方法**：
...
**文件路径**：`include/nova/logger/logger.hpp`
*   **功能**：提供统一的格式化日志接口。
*   **核心方法**：
...
**文件路径**：`include/nova/ssp/ssp_loader.hpp`
